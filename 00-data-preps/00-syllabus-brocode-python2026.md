...
**Instalasi Python ➜ at Windows**

- [ ] Via Microsoft Store Package
- [x] Via Official Python installer
- [ ] Via Chocolatey package manager
- [ ] Via Windows Subsystem for Linux (WSL)

**Python Editor & Plugin**
Preferensi editor: **VSCode** dengan tambahan ;

- [x] Extension **Python**, untuk mendapatkan benefit API doc, autocompletion, linting, run feature, dan lainnya.
